...
mod constants {
	use crate::cipher::des::permutation::PermutationTable;

	pub const IP: PermutationTable<64, 64> = PermutationTable::new([
	...
	pub const IP_INV: PermutationTable<64, 64> = PermutationTable::new([
	...
	pub const E: PermutationTable<48, 32> = PermutationTable::new([
	...
	pub const P: PermutationTable<32, 32> = PermutationTable::new([
